...
class PartyState extends MusicBeatState
{
  ...
  {
    if (canStart2 && (FlxG.keys.justPressed.LEFT || FlxG.keys.justPressed.RIGHT)) clickAction(2);
    if (FlxG.keys.justPressed.A)
    {
      if (canStart) clickAction(4);
      if (canStart2) clickAction(3);
    }
    ...
    if (FlxG.mouse.justPressed)
    {
      ...
      if (canStart2)
      {
        if (FlxG.mouse.overlaps(rulesTouch)) clickAction(0);
        else if (FlxG.mouse.overlaps(tipsTouch)) clickAction(1);
        else if (FlxG.mouse.overlaps(leftTouch)) clickAction(2);
        else if (FlxG.mouse.overlaps(rightTouch)) clickAction(2);
        else if (FlxG.mouse.overlaps(startTouch)) clickAction(3);
      }
      if (canStart && FlxG.mouse.overlaps(titleTouch)) clickAction(4);
    }
