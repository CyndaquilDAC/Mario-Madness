...
class StoryMenuState extends MusicBeatSubstate
{
  ...
  var cutReq:Array<Bool> = [
    ...
    ClientPrefs.storySave[0],
    ClientPrefs.storySave[0],
    (ClientPrefs.worlds[2] >= 4 || ClientPrefs.worldsALT[1] == 2),
    (ClientPrefs.worldsALT[3] == 1 || ClientPrefs.worldsALT[3] == 3),
    (ClientPrefs.worlds[3] == 6),
    (ClientPrefs.worlds[4] >= 1),
    (ClientPrefs.worlds[4] >= 2)
  ];
  ...
  override function create()
  {
    ...
    dumbTween = FlxTween.num(2.0, 0.8, 4, {ease: FlxEase.expoOut}, (v:Float) -> {
      MainMenuState.instance.bloom.dim.value = [v];
    });
    ...
    dumbTween2 = FlxTween.num(0, 0.5, 4, {ease: FlxEase.expoOut}, (v:Float) -> {
      staticShader.strengthMulti.value = [v];
    });
