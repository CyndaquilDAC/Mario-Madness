...
class KeyboardTestingState extends MusicBeatState
{
  ...
  override function create()
  {
    ...
    keyboard = new Keyboard(mainCam, 25, 210, Paths.font("BIOSNormal.ttf"), 16, FlxColor.RED, "", "", "", false, temp.pixels, temp2.pixels, null, true, null,
      temp.pixels, temp2.pixels, 50, 50, 0, -1, 0.0, 0.0);
