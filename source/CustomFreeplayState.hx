...
class CustomFreeplayState extends MusicBeatSubstate
{
  ...
  var opValid:Array<Bool> = [
    ...
    ClientPrefs.storySave[3],
    ClientPrefs.storySave[4],
    ClientPrefs.storySave[5],
    ClientPrefs.storySave[9],
  ...
  override function create()
  {
    ...
    for (i in 0...options.length)
    {
      ...
      imagePortrait.color = 0xFF000000;
      imagePortrait.alpha = 0.9;
...
class FreeplaySubState extends MusicBeatSubstate
{
  ...
  function changeSelection(change:Int = 0)
  {
    ...
    {
      curSelected += change;
      if (curSelected < 0) curSelected = CustomFreeplayState.canciones.length - 1;
      if (curSelected >= CustomFreeplayState.canciones.length) curSelected = 0;
    }
  ...
  function goToSong()
  {
    ...
    tween = FlxTween.tween(FlxG.camera, {zoom: FlxG.camera.zoom + 0.2}, 2,
      {
    ...
    tween = FlxTween.tween(FlxG.sound.music, {volume: 0}, 0.2, {ease: FlxEase.quadOut, onComplete: function(twn:FlxTween) {
    ...
    tween = FlxTween.tween(MainMenuState.instance.estatica, {alpha: 0}, 2,
      {
        ...
        onComplete: function(twn:FlxTween) {
          ...
          if (FlxG.keys.pressed.H && CustomFreeplayState.canciones[curSelected][1] == 'demise') dewottchart = 'DONTUSE';
