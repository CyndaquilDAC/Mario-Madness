...
class WarpData
{
  public static final script:Array<Dynamic> = [
    ["Well done", 0.2],
    ["Very well done", 2.2],
    ["I must say, I am impressed", 4.6],
    ["Youre a long way from home", 9],
    ["Arent you?", 10.7],
    ["Tell me, why do you persist?", 12.2],
    ["", 15.2],
    ["No matter", 15.8],
    ["All good things", 17.2],
    ["Must come to an end", 18],
    ["You broke our little deal", 19.8],
    ["And I can't let that slide", 22.3],
    ["", 24.2],
    ["And", 25],
    ["You fell right", 25.7],
    ["Into my hands", 26.7],
    ["Thinking your path was clear", 28],
    ["The goalpost in sight", 29.9],
    ["But no", 31.6],
    ["", 32.8],
    ["Tell me", 33.7],
    ["Do you know what", 34.7],
    ["All of the creatures", 35.3],
    ["Down there have in common?", 36.1],
    ["They're all in my game", 38.5],
    ["They all", 41.1],
    ["Belong", 42.3],
    ["To me", 43.5],
    ["YOU CANNOT UNDO", 45.7],
    ["WHAT HAS BEEN STARTED", 47.6],
    ["YOUR FATE WAS SET", 50],
    ["IN MOTION THE MOMENT", 51.6],
    ["YOU LAID EYES", 53],
    ["ON THAT LITTLE CARTRIDGE", 53.9],
    ["THE BOTH OF YOU", 56.5],
    ["ARE MY PLAYTHINGS NOW", 57.4],
    ["AND WE'RE GOING TO HAVE", 59.5],
    ["SO MUCH FUN!!!", 61],
    ["", 63.6],
    ["Come and face me", 65],
    ["Little rat", 67],
    ["Your time has come", 68.5],
    ["", 71.4],
    ["", 72.4]
  ];
          ...
          case 2:
            switch (lastDir)
            {
              case 1:
                ...
                theTweenY = FlxTween.tween(pibe, {y: y}, 1.2, {onComplete: function(twn:FlxTween) {
          ...
          case 5:
            switch (lastDir)
            {
              case 4:
                ...
                theTweenY = FlxTween.tween(pibe, {y: y}, 0.8, {onComplete: function(twn:FlxTween) {
                  pibe.animation.play('right');
                }});
              case 6:
                WarpState.time = 2.2;
                ...
                theTweenY = FlxTween.tween(pibe, {y: y}, 1.7, {onComplete: function(twn:FlxTween) {
      ...
      case 3: // !WORLD 3
        switch (nextDir)
        {
          case 0:
            WarpState.time = 2.8;
            pibe.animation.play('left');
            theTweenX = FlxTween.tween(pibe, {x: 403}, 0.3,
              {
                onComplete: function(twn:FlxTween) {
                  pibe.animation.play('up');
                  FlxTween.tween(pibe, {x: 469}, 1.3,
                    {
                      onComplete: function(twn:FlxTween) {
            ...
            theTweenY = FlxTween.tween(pibe, {y: 447}, 0.3,
              {
                onComplete: function(twn:FlxTween) {
                  FlxTween.tween(pibe, {y: 306}, 1.3,
                    {
                      onComplete: function(twn:FlxTween) {
                        pibe.animation.play('right');
          ...
          case 1:
            switch (lastDir)
            {
              case 0:
                WarpState.time = 3.1;
                theTweenX = FlxTween.tween(pibe, {x: 469}, 1.2,
                  {
                    onComplete: function(twn:FlxTween) {
                      pibe.animation.play('down');
                      FlxTween.tween(pibe, {x: 403}, 1.1,
                        {
                          onComplete: function(twn:FlxTween) {
                ...
                theTweenY = FlxTween.tween(pibe, {y: 306}, 1.2,
                  {
                    onComplete: function(twn:FlxTween) {
                      FlxTween.tween(pibe, {y: 447}, 1.3,
                        {
                          onComplete: function(twn:FlxTween) {
                            pibe.animation.play('right');
              ...
              case 2:
                ...
                theTweenY = FlxTween.tween(pibe, {y: 492}, 0.3,
                  {
                    startDelay: 0.2,
                    onComplete: function(twn:FlxTween) {
          ...
          case 2:
            switch (lastDir)
            {
              ...
              case 3:
                WarpState.time = 1.8;
                pibe.animation.play('left');
                theTweenY = FlxTween.tween(pibe, {y: pibe.y}, 0.2,
                  {
                    onComplete: function(twn:FlxTween) {
                ...
                theTweenX = FlxTween.tween(pibe, {x: 739}, 1.6,
                  {
                    onComplete: function(twn:FlxTween) {
          ...
          case 3:
            switch (lastDir)
            {
              case 2:
                WarpState.time = 2.8;
                pibe.animation.play('left');
                theTweenY = FlxTween.tween(pibe, {y: y}, 2, {startDelay: 0.2, onComplete: function(twn:FlxTween) {
                  pibe.animation.play('right');
                }});
                theTweenX = FlxTween.tween(pibe, {x: 739}, 0.2,
                  {
                    onComplete: function(twn:FlxTween) {
                      pibe.animation.play('up');
              ...
              case 4: // 790, 213   703, 138    622, 138
                WarpState.time = 2.2;
                theTweenX = FlxTween.tween(pibe, {x: 625}, 0.2,
                  {
                    onComplete: function(twn:FlxTween) {
                      FlxTween.tween(pibe, {x: x}, 2);
                    }
                  });
                theTweenY = FlxTween.tween(pibe, {y: 132}, 0.2,
                  {
                    onComplete: function(twn:FlxTween) {
                      pibe.animation.play('right');
          ...
          case 4:
            switch (lastDir)
            {
              case 3:
                WarpState.time = 2.7;
                theTweenX = FlxTween.tween(pibe, {x: 790}, 0.3,
                  {
                    onComplete: function(twn:FlxTween) {
                      pibe.animation.play('up');
                      FlxTween.tween(pibe, {x: 622}, 2,
                        {
                          onComplete: function(twn:FlxTween) {
                            pibe.animation.play('up');
                ...
                theTweenY = FlxTween.tween(pibe, {y: 213}, 0.3,
                  {
                    onComplete: function(twn:FlxTween) {
                      FlxTween.tween(pibe, {y: 138}, 0.8,
                        {
                          onComplete: function(twn:FlxTween) {
                            pibe.animation.play('left');
              ...
              case 5:
                WarpState.time = 2.7;
                theTweenX = FlxTween.tween(pibe, {x: 409}, 0.3,
                  {
                    onComplete: function(twn:FlxTween) {
                      FlxTween.tween(pibe, {x: 571}, 2,
                        {
                          onComplete: function(twn:FlxTween) {
                            FlxTween.tween(pibe, {x: x}, 0.4);
                          }
          ...
          case 5:
            switch (lastDir)
            {
              case 4:
                WarpState.time = 2.25;
                theTweenX = FlxTween.tween(pibe, {x: 556}, 0.3,
                  {
                    onComplete: function(twn:FlxTween) {
                      pibe.animation.play('left');
                      FlxTween.tween(pibe, {x: 403}, 1.4,
                        {
                          onComplete: function(twn:FlxTween) {
                            FlxTween.tween(pibe, {x: x}, 0.4);
                          }
                ...
                theTweenY = FlxTween.tween(pibe, {y: 138}, 0.3,
                  {
                    onComplete: function(twn:FlxTween) {
                      FlxTween.tween(pibe, {y: 216}, 0.8,
                        {
                          startDelay: 0.65,
                          onComplete: function(twn:FlxTween) {
        ...
        switch (nextDir)
        {
          ...
          case 2:
            switch (lastDir)
            {
              ...
              case 5:
                WarpState.time = 5;
                theTweenX = FlxTween.tween(pibe, {x: 905}, 0.4,
                  {
                    onComplete: function(twn:FlxTween) {
                      pibe.animation.play('climb');
                      theTweenX = FlxTween.tween(pibe, {x: 905}, 1.4,
                        {
                          onComplete: function(twn:FlxTween) {
                ...
                theTweenY = FlxTween.tween(pibe, {y: y}, 2.5,
                  {
                    onComplete: function(twn:FlxTween) {
                      pibe.animation.play('left');
                    }
          ...
          case 3:
            switch (lastDir)
            {
              case 2:
                WarpState.time = 2.8;
                theTweenX = FlxTween.tween(pibe, {x: x}, 2.2,
                  {
                    onComplete: function(twn:FlxTween) {
                      pibe.animation.play('up');
                    }
              ...
              case 4:
                WarpState.time = 2.2;
                theTweenX = FlxTween.tween(pibe, {x: pibe.x}, 0.4,
                  {
                    onComplete: function(twn:FlxTween) {
                      pibe.animation.play('climb');

                      theTweenX = FlxTween.tween(pibe, {x: pibe.x}, 0.7,
                        {
                          onComplete: function(twn:FlxTween) {
                            pibe.animation.play('down');
                ...
                theTweenY = FlxTween.tween(pibe, {y: y}, 1.5,
                  {
                    onComplete: function(twn:FlxTween) {
                      pibe.animation.play('right');
                    }
            ...
            theTweenX = FlxTween.tween(pibe, {x: x}, 1,
              {
                onComplete: function(twn:FlxTween) {
                  ...
                  theTweenX = FlxTween.tween(pibe, {x: x}, 0.1,
                    {
                      onComplete: function(twn:FlxTween) {
                        pibe.animation.play('climb');
                        theTweenX = FlxTween.tween(pibe, {x: x}, 0.8,
          ...
          case 5:
            WarpState.time = 5;
            theTweenX = FlxTween.tween(pibe, {x: x}, 2.5,
              {
                onComplete: function(twn:FlxTween) {
                  pibe.animation.play('up');
                  theTweenX = FlxTween.tween(pibe, {x: x}, 0.7,
                    {
                      onComplete: function(twn:FlxTween) {
                        pibe.animation.play('climb');
                        theTweenX = FlxTween.tween(pibe, {x: x}, 1.4,
                          {
                            onComplete: function(twn:FlxTween) {
                              pibe.animation.play('up');
                            }
          ...
          case 7:
            WarpState.time = 2.2;
            theTweenX = FlxTween.tween(pibe, {x: x}, 0.15,
              {
                onComplete: function(twn:FlxTween) {
                  pibe.animation.play('climb');
                  theTweenX = FlxTween.tween(pibe, {x: x}, 1.7,
                    {
                      onComplete: function(twn:FlxTween) {
                        pibe.animation.play('up');
                      }
          ...
          case 6:
            ...
            switch (lastDir)
            {
              case 7:
                WarpState.time = 2.2;
                theTweenX = FlxTween.tween(pibe, {x: x}, 0.35,
                  {
                    onComplete: function(twn:FlxTween) {
                      pibe.animation.play('climb');
                      theTweenX = FlxTween.tween(pibe, {x: x}, 1.7,
  ...
  public static function getWorld(bonnie:Float):Array<Dynamic>
  {
    ...
    switch (bonnie)
    {
      ...
      case 4:
        ...
        { // cambia este valor con el guardado q indique que terminaste all stars
          elcausa[0][1] = '1';
          elcausa[2][2] = '1';
        }
  ...
  public static function getPos(foxy:Float):Array<Dynamic>
  {
    ...
    {
      case 1:
        elboludo = [['star', 525, 280], ['dot', 531, 428], ['none', 0, 0], ['ring', 697, 237]];
      ...
      case 5:
        elboludo = [['star', 630, 656], ['dot', 636, 471], ['dot', 636, 260], ['big', 632, 46]];
    }
