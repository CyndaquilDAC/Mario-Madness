...
class CreditsState extends MusicBeatState
{
  ...
  override public function create()
  {
    ...
    if (autoscroll)
    {
      ...
      FlxTween.tween(bgEasterEggArray[0], {alpha: 1}, 20,
        {
          onComplete: function(shit:FlxTween) {
            FlxTween.tween(bgEasterEggArray[0], {alpha: 0}, 5,
              {
                onComplete: function(shit:FlxTween) {
                  FlxTween.tween(bgEasterEggArray[1], {alpha: 1}, 20,
                    {
                      onComplete: function(shit:FlxTween) {
                        FlxTween.tween(bgEasterEggArray[1], {alpha: 0}, 5,
                          {
                            onComplete: function(shit:FlxTween) {
                              FlxTween.tween(bgEasterEggArray[2], {alpha: 1}, 20,
                                {
                                  onComplete: function(shit:FlxTween) {
                                    FlxTween.tween(bgEasterEggArray[2], {alpha: 0}, 5,
                                      {
                                        onComplete: function(shit:FlxTween) {
                                          FlxTween.tween(bgEasterEggArray[3], {alpha: 1}, 20,
                                            {
                                              onComplete: function(shit:FlxTween) {
                                                FlxTween.tween(bgEasterEggArray[3], {alpha: 0}, 5,
                                                  {
                                                    onComplete: function(shit:FlxTween) {
                                                      FlxTween.tween(bgEasterEggArray[4], {alpha: 1}, 20,
                                                        {
                                                          onComplete: function(shit:FlxTween) {
                                                            FlxTween.tween(bgEasterEggArray[4], {alpha: 0}, 5,
                                                              {
                                                                onComplete: function(shit:FlxTween) {
                                                                  FlxTween.tween(bgEasterEggArray[5], {alpha: 1}, 20,
                                                                    {
                                                                      onComplete: function(shit:FlxTween) {
                                                                        FlxTween.tween(bgEasterEggArray[5], {alpha: 0}, 5,
                                                                          {
                                                                            onComplete: function(shit:FlxTween) {
    ...
    for (i in 0...41)
    {
      ...
      if (i % 2 != 0) icon.x = creditX + 420;

      title = new FlxText(creditX, creditY - 10, 0, "", 32);
      title.text = infoArray[0];
      title.setFormat(Paths.font("Mario64.ttf"), 48, FlxColor.RED, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
      ...
      devrole.setFormat(Paths.font("Mario64.ttf"), 26, FlxColor.RED, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
      devrole.borderSize = 1.7;
    ...
    specialThanksTitle.setFormat(Paths.font("Mario64.ttf"), 48, FlxColor.RED, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
    title.borderSize = 1.7;
    ...
    for (i in 0...infoArray.length)
    {
      ...
      specialThanksText.setFormat(Paths.font("Mario64.ttf"), 21, FlxColor.RED, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
      title.borderSize = 1.7;
    ...
    lyricsText.setFormat(Paths.font("Mario64.ttf"), 40, FlxColor.RED, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
    title.borderSize = 1.7;
  ...
  override function update(elapsed:Float)
  {
    if (!autoscroll)
    {
      ...
      if (FlxG.mouse.wheel < 0) newPos += 40;
      if (FlxG.mouse.wheel > 0) newPos -= 40;

      if (newPos < 200) newPos = 200;

      if (12920 < newPos) newPos = 12920;
