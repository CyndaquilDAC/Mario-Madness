...
class WarpState extends MusicBeatState
{
  ...
  private var starPos:Array<Dynamic> = [[435, 298], [528, 310], [624, 310], [720, 310], [816, 310], [912, 310],];
  ...
  override function create()
  {
    ...
    if (startCut && !ClientPrefs.storySave[1])
    {
      ...
      new FlxTimer().start(1.7, function(tmr:FlxTimer) {
        ...
        FlxTween.tween(introBox.scale, {y: 3, x: 3}, 0.5,
          {
...
class WorldState extends MusicBeatSubstate
{
  ...
  private static var posmierda:Array<Dynamic> = [
    // la posicion en el mismo orden que las canciones esas bien mierda
    // ICON, 	 X, Y,
    ['star', 345, 356],
    ['dot', 450, 363],
    ['none', 0, 0],
...
class PipeState extends MusicBeatSubstate
{
  ...
  override function create()
  {
    ...
    FlxTween.tween(pipe.scale, {y: 1.3, x: 1.3}, 3,
      {
        startDelay: 1.5,
        ease: FlxEase.expoIn,
        onComplete: function(twn:FlxTween) {
