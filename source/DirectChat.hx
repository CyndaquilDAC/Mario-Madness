  ...
  public static function addMessage()
  {
    if (!tooLong)
    {
      ...
      switch (chosenUsername)
      {
        ...
        case 'turmoil':
          if (FlxG.random.bool(50)) chosenMessage = "i'm hungry";

        case 'mx':
          if (FlxG.random.bool(50)) chosenMessage = "innocence doesn't get you far";
          else
            chosenMessage = "lucas...";
        ...
        case 'moldy mario':
          if (FlxG.random.bool(50)) chosenMessage = "i am trapped in your sewer";
          else
        ...
        case 'winniethepooh':
          if (FlxG.random.bool(50)) chosenMessage = "oh b(r)other";
          else
            chosenMessage = "i'm winnie the pooh";

        case 'mr.l':
          if (FlxG.random.bool(50)) chosenMessage = "it's too late";
          else
            chosenMessage = "L-ater";

        case 'JackBlack':
          if (FlxG.random.bool(50)) chosenMessage = "FUCK YOU! YOU FUCKIN' DICK";
          else
        ...
        case 'useraqua':
          if (FlxG.random.bool(50)) chosenMessage = "holy sweet mother of pibby";
          else
        ...
        case 'Ney':
          if (FlxG.random.bool(50)) chosenMessage = "This isn't the video to get free V-Bucks";
          else
            chosenMessage = "NO WAY! It's Piss Chratt!";

        case 'Linkara':
          if (FlxG.random.bool(50)) chosenMessage = "If its you or the worms I pick the worms every time";
          else
        ...
        case 'Walter_White':
          if (FlxG.random.bool(50)) chosenMessage = "We need to COOK";
          else
        ...
        case 'Super Wario Man':
          if (FlxG.random.bool(50)) chosenMessage = "Esta bonito";
          else
        ...
        case 'WhiteyDvl':
          if (FlxG.random.bool(50)) chosenMessage = "THAT'S a technical fouuul...";
          else
            chosenMessage = "Here comes the seuizure nyeuuughghghjuhgh";

        case 'EleanorDvl':
          if (FlxG.random.bool(50)) chosenMessage = "Has anyone seen my wig";
          else
        ...
        case 'misterSYS':
          if (FlxG.random.bool(50)) chosenMessage = "this song is truly unbeatable";
      }
